...
namespace VidyoClient
{
	public class LoggerCategoryFactory
	{
		...
		{
			return new LoggerCategory(IntPtr.Zero);
		}
	...
	public class LoggerCategory {
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr VidyoLoggerCategoryConstructCopyNative(IntPtr obj);
		...
		public LoggerCategory(IntPtr obj){
			if(obj == IntPtr.Zero) {
				objPtr = VidyoLoggerCategoryConstructDefaultNative();
			}
			else {
				objPtr = VidyoLoggerCategoryConstructCopyNative(obj);
			}

			List<String> csLevels = new List<String>();
			var nLevelsSize = 0;
			var nLevels = VidyoLoggerCategoryGetlevelsArrayNative(VidyoLoggerCategoryGetlevelsNative(objPtr), ref nLevelsSize);
			var nLevelsIndex = 0;
		...
		~LoggerCategory() {
			VidyoLoggerCategoryDestructNative(objPtr);
		 }
	};
}
